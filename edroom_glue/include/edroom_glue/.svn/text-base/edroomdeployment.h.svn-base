...
//Signal Conversion
	...
	static TEDROOMSignal C4HKFDIRMng_PHK_FDIRCtrl__C2EPDManager_PHK_FDIRCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C2EPDManager_PHK_FDIRCtrl__C4HKFDIRMng_PHK_FDIRCtrl(TEDROOMSignal signal);
 
//Signal Conversion
 
	static TEDROOMSignal C3TM_ChannelCtrl_PTMChannelCtrl2__C4HKFDIRMng_PTMChannelCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C4HKFDIRMng_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl2(TEDROOMSignal signal);
